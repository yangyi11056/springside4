 ...
 *******************************************************************************/
package com.springx.examples.quickstart.service.account;
...
import com.springx.examples.quickstart.data.UserData;
import com.springx.examples.quickstart.entity.User;
import com.springx.examples.quickstart.repository.TaskDao;
import com.springx.examples.quickstart.repository.UserDao;
import com.springx.examples.quickstart.service.ServiceException;
import com.springx.examples.quickstart.service.account.ShiroDbRealm.ShiroUser;
import com.springx.modules.test.security.shiro.ShiroTestUtils;
import com.springx.modules.utils.Clock.MockClock;
