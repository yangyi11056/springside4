 ...
 *******************************************************************************/
package com.springx.examples.showcase.demos.mail;
...
import com.springx.examples.showcase.demos.utilities.email.MimeMailService;
import com.springx.examples.showcase.demos.utilities.email.SimpleMailService;
...
public class MailServiceTest extends SpringContextTestCase {
	...
	public void sendSimpleMail() throws MessagingException, InterruptedException, IOException {
		...
		assertThat(message.getFrom()[0].toString()).isEqualTo("springx3.demo@gmail.com");
