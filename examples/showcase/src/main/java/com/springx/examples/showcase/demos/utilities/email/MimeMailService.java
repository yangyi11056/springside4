 ...
 *******************************************************************************/
package com.springx.examples.showcase.demos.utilities.email;
...
public class MimeMailService {
	...
	public void sendNotificationMail(String userName) {
		...
		try {
			...
			helper.setTo("springx3.demo@gmail.com");
			helper.setFrom("springx3.demo@gmail.com");
			...
			mailSender.send(msg);
			logger.info("HTML版邮件已发送至springx3.demo@gmail.com");
