 ...
 *******************************************************************************/
package com.springx.examples.showcase.webservice.soap;
...
import com.springx.examples.showcase.service.AccountEffectiveService;
import com.springx.examples.showcase.webservice.soap.response.GetTeamDetailResult;
import com.springx.examples.showcase.webservice.soap.response.GetUserResult;
import com.springx.examples.showcase.webservice.soap.response.SearchUserResult;
import com.springx.examples.showcase.webservice.soap.response.base.IdResult;
import com.springx.examples.showcase.webservice.soap.response.base.WSResult;
import com.springx.examples.showcase.webservice.soap.response.dto.TeamDTO;
...
import com.springx.modules.mapper.BeanMapper;
...
@WebService(serviceName = "AccountService", endpointInterface = "com.springx.examples.showcase.webservice.soap.AccountSoapService", targetNamespace = WsConstants.NS)
