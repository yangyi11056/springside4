 ...
 *******************************************************************************/
package com.springx.examples.showcase.demos.redis.job.producer;

import java.util.concurrent.TimeUnit;
import java.util.concurrent.atomic.AtomicLong;

import com.springx.examples.showcase.demos.redis.job.dispatcher.SimpleJobDispatcherDemo;
import com.springx.modules.nosql.redis.pool.JedisPool;
import com.springx.modules.nosql.redis.pool.JedisPoolBuilder;
import com.springx.modules.nosql.redis.service.scheduler.JobProducer;
